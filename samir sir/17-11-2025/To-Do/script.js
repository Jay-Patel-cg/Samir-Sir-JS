...
// var select1 = document.getElementById("all");
// var select2 = document.getElementById("rem");
// var select3 = document.getElementById("com");
...
// select1.addEventListener('click',todoList);
// select1.addEventListener('click',remList);
// select1.addEventListener('click',comdoList);
